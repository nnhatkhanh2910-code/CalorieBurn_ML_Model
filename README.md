...
| **Trần Thị Nhật Khánh** | 11245886         | Thiết kế giao diện website cho các features: Class picker, What-if coach, Meal Suggest.<br> Viết nội dung và thuyết trình về sản phẩm website.                                                                                                                                       | **16.7%** |
